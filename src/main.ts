...
async function bootstrap() {
  ...
  app.use(
    accessGuard({
      ...
      allow: ['/api/notifications/health', '/api/notifications/ready', '/api/notifications/me'],
    }),
  );
  ...
  console.log(`mis-notification-service listening on http://localhost:${port}/${PREFIX}`);
}
bootstrap();
